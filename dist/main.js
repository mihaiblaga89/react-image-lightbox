            ...
            var ReactImageLightbox = function(_Component) {
                ...
                return _inherits(ReactImageLightbox, _Component), _createClass(ReactImageLightbox, null, [ {
                    ...
                    value: function() {
                        ...
                        return _react2.default.createElement(_reactModal2.default, _extends({
                        ...
                        })), showDownload && _react2.default.createElement("li", {
                            className: "ril-toolbar__item " + styles.toolbarItem
                        }, _react2.default.createElement("button", {
                            // Lightbox zoom out button
                            type: "button",
                            title: "Download",
                            "aria-label": "Download",
                            className: [ "ril-download", styles.toolbarItemChild, styles.builtinButton, styles.downloadButton ].join(" "),
                            onClick: function() {
                                window && window.open(_this16.getBestImageForType("mainSrc").src, "_blank");
                            }
                        })), _react2.default.createElement("li", {
                            className: "ril-toolbar__item " + styles.toolbarItem
                        }, _react2.default.createElement("button", {
 ...
 */
    ...
    function(module, exports, __webpack_require__) {
        ...
        exports.locals = {
            ...
            downloadButton: "ril__downloadButton",
